...
public class AutoaiDownload {
    ...
    public static String fileDownloadPath;//文件下载目录
    ...
    public static void init(Context context) {
        //////////////1、初始化框架文件系统
        //创建文件系统根目录：/storage/emulated/0/Android/data/com.xxx.xxx/files/AutoaiDownload/
        File root = context.getExternalFilesDir("AutoaiDownload");
        //创建文件下载目录
        ...
        String dataBaseloadPath = dataBaseDirFile.getAbsolutePath();//数据库目录
...
//     */
//    public static DownloadInfo addNewDownload(String fileName, String downloadUrl, String fileSavePath, DownloadListener downloadListener) throws DbException {
...
//
//    //继续下载指定任务
//    public static void resumeDownload(DownloadInfo downloadInfo, DownloadListener downloadListener) throws DbException {
//        downloadManager.resumeDownload(downloadInfo, downloadListener);
//    }
//
//    //停止下载指定的下载任务
//    public static void stopDownload(DownloadInfo downloadInfo) throws DbException {
//        downloadManager.stopDownload(downloadInfo);
//
//    }
//
//    //删除下载指定任务
//    public static void removeDownload(DownloadInfo downloadInfo) throws DbException {
